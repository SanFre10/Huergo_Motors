...
namespace TP1Ventas
{
    ...
    {
        public static string ConnectionString = @"Data Source=SQL5049.site4now.net;Initial Catalog=DB_9CF8B6_HuergoMotorsVentas;User Id=DB_9CF8B6_HuergoMotorsVentas_admin;Password=huergo2020;";
